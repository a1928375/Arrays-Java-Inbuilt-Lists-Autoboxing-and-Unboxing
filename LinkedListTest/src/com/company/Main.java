...
//                    if (playList.size() == 0) {
//
//                        System.out.println("No song lest in this play list");
//                        break;
//
...
//
//                    listIterator.next();
//                    String result = listIterator.previous().getTitle();
//
...
//                        i++;
//
//                        System.out.println("The #" + i + " song in the playlist is " + listIterator.next().getTitle());
//                    }
//
//                    while (true) {
//
//                        Song answer = listIterator.previous();
//                        answer = listIterator.next();
//
//                        listIterator.previous();
//
//                        if (answer.getTitle().equals(result)) {
//
//                            break;
//                        }
//                    }
    ...
    public static boolean addToList (Album album, String title) {
        ...
        if (album.getMyAlbum().isEmpty()) {

            System.out.println("Cannot find this album");
            return false;
        }

        for (int i = 0; i < album.getMyAlbum().size(); i++) {

            if (album.getMyAlbum().get(i).getTitle().equals(title)){

                playList.add(album.getMyAlbum().get(i));
                return true;
            }
        }
